...
const LoginPage = ({ navigation }: LoginPageProps) => {
   ...
   return (
      <View style={{ flex: 1, justifyContent: "center", alignItems: "center" }}>
         ...
         <TextInput style={{ height: 40 }} placeholder="Username or Email" onChangeText={setUsernameEntered} />
         <Text style={{ fontWeight: "bold" }}>Password:</Text>
         <TextInput style={{ height: 40 }} placeholder="Password goes here!" onChangeText={setPasswordEntered} />
